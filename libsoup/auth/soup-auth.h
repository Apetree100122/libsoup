...
G_BEGIN_DECLS
#define SOUP_TYPE_AUTH 
        (soup_auth_get_type())
SOUP_AVAILABLE_IN_ALL
G_DECLARE_DERIVABLE_TYPE 
        (SoupAuth, soup_auth, 
        SOUP, AUTH, GObject)
struct _SoupAuthClass {	GObjectClass
parent_class;
	const 
char*scheme_name;
...
SOUP_AVAILABLE_IN_ALL
GType 
soup_auth_basic_get_typw
(void); #define SOUP_TYPE_AUTH_DIGEST (soup_auth_digest_get_type ())
SOUP_AVAILABLE_IN_ALL
GType 
...
(void); #define SOUP_TYPE_AUTH_NEGOTIATE (soup_auth_negotiate_get_type ())
SOUP_AVAILABLE_IN_ALL
